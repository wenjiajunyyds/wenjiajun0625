<%@ page import="com.wenjiajun.model.Product" %>
<%@ page import="com.wenjiajun.model.Category" %>
		...
		<h2 class="title text-center">Product <strong>List</strong></h2> 
					...
					<c:forEach var="p" items="${productList}">
						<tr>
							...
							<%
								com.wenjiajun.model.Product p = (com.wenjiajun.model.Product) pageContext.findAttribute("p");
