			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.wenjiajun.model.Order o=(com.wenjiajun.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.wenjiajun.dao.UserDao userDao=new com.wenjiajun.dao.UserDao();
						...
						<p>${o.address1}</p>
						<p>${o.address2}</p>
						<p>${o.city},${o.state},${o.country}-${o.postalCode}</p>${o.phone}</p></td>
						<td class="cart_total">
						<%
							int n=o.getPaymentId();
							String paymentType=com.wenjiajun.model.Payment.findByPaymentId(con,n);
							 %>
