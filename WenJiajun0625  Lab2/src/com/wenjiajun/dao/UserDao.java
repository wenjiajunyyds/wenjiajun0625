...
public class UserDao implements IUserDao{
    ...
    public int updateUser(Connection con, User user) throws SQLException {
        ...
        String sql="update usertable set id='"+user.getId()+"',username='"+user.getUsername()+"',password='"+user.getPassword()+"',email='"+user.getEmail()+"',gender='"+user.getGender()+"',birthdate='"+birth+"' where id ='"+user.getId()+"' ";
        PreparedStatement st=con.prepareStatement(sql);
        int rs=st.executeUpdate();
        return rs;
    }
